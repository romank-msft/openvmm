...
VTL0_KERNEL="target/x86_64-unknown-none/${VTL0_KERNEL_BUILD}/simple_tmk"
cargo build -p simple_tmk --config openhcl/minimal_rt/x86_64-config.toml --${VTL0_KERNEL_BUILD}
    ...
    "guest_configs": [
        {
            ...
            "image": {
                "openhcl": {
                    "command_line": "OPENHCL_FORCE_LOAD_VTL0_IMAGE=linux OPENHCL_BOOT_LOG=com3 OPENHCL_SIGNAL_VTL0_STARTED=1",
