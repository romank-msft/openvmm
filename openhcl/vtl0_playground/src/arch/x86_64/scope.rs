...
pub struct Scope<'scope, 'env: 'scope> {
    ...
    pub arch: ArchScopeState,
    pub _scope: PhantomData<&'scope mut &'scope ()>,
    pub _env: PhantomData<&'env mut &'env ()>,
}
...
impl<'scope> Scope<'scope, '_> {
    pub fn arch_init() -> ArchScopeState {
        ArchScopeState {
            old_isrs: None,
